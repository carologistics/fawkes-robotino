...
(defrule domain-load-global-facts
  ...
  (assert
    ...
    (domain-object (name C5) (type container))
    ...
    (domain-fact (name container-can-be-filled) (param-values C5))
    ...
    (domain-fact (name container-at) (param-values C5 CONTAINER-DEPOT))
