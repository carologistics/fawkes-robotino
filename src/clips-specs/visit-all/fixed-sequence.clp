...
(defrule goal-expander-create-sequence
	...
	(plan-action (id 8) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-BS OUTPUT CYAN))
	(plan-action (id 9) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot1/Skiller")
	             (param-values C-CS1 OUTPUT CYAN))
	(plan-action (id 10) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-CS2 OUTPUT CYAN))
	(plan-action (id 11) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-RS1 OUTPUT CYAN))
	(plan-action (id 12) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-RS2 OUTPUT CYAN))
	(plan-action (id 13) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-SS OUTPUT CYAN))
	(plan-action (id 14) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot2/Skiller")
	             (param-values C-DS OUTPUT CYAN))
				 
	(plan-action (id 15) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-BS OUTPUT CYAN))
	(plan-action (id 16) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-CS1 OUTPUT CYAN))
	(plan-action (id 17) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-CS2 OUTPUT CYAN))
	(plan-action (id 18) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-RS1 OUTPUT CYAN))
	(plan-action (id 19) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-RS2 OUTPUT CYAN))
	(plan-action (id 20) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-SS OUTPUT CYAN))
	(plan-action (id 21) (plan-id TESTGOAL-PLAN) (goal-id TESTGOAL)
	             (action-name visit) (skiller "/robot3/Skiller")
	             (param-values C-DS OUTPUT CYAN))
	 )
