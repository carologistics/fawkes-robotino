...
(defrule domain-load
  ...
  (not (domain-loaded))
=>
  (parse-pddl-domain (path-resolve "rcll-smt/domain.pddl"))
...
(defrule domain-load-initial-facts
  ...
  (assert
    ...
    (domain-object (name WP1PRODUCE-C3) (type workpiece))
    (domain-object (name WP2PRODUCE-C3) (type workpiece))
    (domain-object (name WP1PRODUCE-C0) (type workpiece))
    (domain-object (name WP2PRODUCE-C0) (type workpiece))
    ...
    (domain-fact (name wp-spawned-by) (param-values WP1PRODUCE-C3 ?self))
    (domain-fact (name wp-base-color) (param-values WP1PRODUCE-C3 BASE_NONE))
    (domain-fact (name wp-cap-color) (param-values WP1PRODUCE-C3 CAP_NONE))
    (domain-fact (name wp-ring1-color) (param-values WP1PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values WP1PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values WP1PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-unused) (param-values WP1PRODUCE-C3))

    (domain-fact (name wp-spawned-by) (param-values WP2PRODUCE-C3 ?self))
    (domain-fact (name wp-base-color) (param-values WP2PRODUCE-C3 BASE_NONE))
    (domain-fact (name wp-cap-color) (param-values WP2PRODUCE-C3 CAP_NONE))
    (domain-fact (name wp-ring1-color) (param-values WP2PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values WP2PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values WP2PRODUCE-C3 RING_NONE))
    (domain-fact (name wp-unused) (param-values WP2PRODUCE-C3))

    (domain-fact (name wp-spawned-by) (param-values WP1PRODUCE-C0 ?self))
    (domain-fact (name wp-base-color) (param-values WP1PRODUCE-C0 BASE_NONE))
    (domain-fact (name wp-cap-color) (param-values WP1PRODUCE-C0 CAP_NONE))
    (domain-fact (name wp-ring1-color) (param-values WP1PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values WP1PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values WP1PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-unused) (param-values WP1PRODUCE-C0))

    (domain-fact (name wp-spawned-by) (param-values WP2PRODUCE-C0 ?self))
    (domain-fact (name wp-base-color) (param-values WP2PRODUCE-C0 BASE_NONE))
    (domain-fact (name wp-cap-color) (param-values WP2PRODUCE-C0 CAP_NONE))
    (domain-fact (name wp-ring1-color) (param-values WP2PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values WP2PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values WP2PRODUCE-C0 RING_NONE))
    (domain-fact (name wp-unused) (param-values WP2PRODUCE-C0))
