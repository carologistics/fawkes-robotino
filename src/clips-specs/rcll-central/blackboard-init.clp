...
(defrule blackboard-init-open-robot-exploration-interfaces
  ...
  (blackboard-open "TagVisionInterface" (remote-if-id ?robot "tag-vision/info"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/0"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/1"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/2"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/3"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/4"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/5"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/6"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/7"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/8"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/9"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/10"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/11"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/12"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/13"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/14"))
  (blackboard-open "Position3DInterface"(remote-if-id ?robot "tag-vision/15"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/1"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/2"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/3"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/4"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/5"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/6"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/7"))
  (blackboard-open "LaserLineInterface" (remote-if-id ?robot "laser-lines/8"))
  (blackboard-open "MotorInterface" (remote-if-id ?robot "Robotino"))
