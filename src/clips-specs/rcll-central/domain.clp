...
" Load all initial domain facts on startup of the game "
  ...
  (assert
    ...
    (domain-fact (name wp-base-color) (param-values CCB1 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCB1 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCB1 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCB1 RING_NONE))
    (domain-fact (name wp-cap-color) (param-values CCB1 CAP_BLACK))
    (domain-fact (name wp-base-color) (param-values CCB2 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCB2 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCB2 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCB2 RING_NONE))
    (domain-fact (name wp-cap-color) (param-values CCB2 CAP_BLACK))
    (domain-fact (name wp-base-color) (param-values CCB3 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCB3 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCB3 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCB3 RING_NONE))
    (domain-fact (name wp-cap-color) (param-values CCB3 CAP_BLACK))
    (domain-fact (name wp-base-color) (param-values CCG1 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCG1 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCG1 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCG1 RING_NONE))
    (domain-fact (name wp-cap-color) (param-values CCG1 CAP_GREY))
    (domain-fact (name wp-base-color) (param-values CCG2 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCG2 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCG2 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCG2 RING_NONE))
    (domain-fact (name wp-cap-color) (param-values CCG2 CAP_GREY))
    (domain-fact (name wp-base-color) (param-values CCG3 BASE_NONE))
    (domain-fact (name wp-ring1-color) (param-values CCG3 RING_NONE))
    (domain-fact (name wp-ring2-color) (param-values CCG3 RING_NONE))
    (domain-fact (name wp-ring3-color) (param-values CCG3 RING_NONE))
