...
" Initialize facts that are not synced."
  ...
  (assert
    ...
    (domain-object (name O1) (type product))
    (domain-object (name O2) (type product))
    (domain-object (name O3) (type product))
    (domain-object (name O4) (type product))
    (domain-object (name O5) (type product))
    (domain-object (name O6) (type product))
    (domain-object (name O7) (type product))
    (domain-object (name O8) (type product))
    (domain-object (name O9) (type product))
