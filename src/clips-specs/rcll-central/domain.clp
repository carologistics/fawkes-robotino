...
" Initialize facts that are not synced."
  ...
  (if (eq ?marker-type ARUCO) then
    (assert
      (domain-fact (name tag-matching) (param-values C-CS1 INPUT CYAN 102))
      (domain-fact (name tag-matching) (param-values C-CS2 INPUT CYAN 104))
      (domain-fact (name tag-matching) (param-values C-RS1 INPUT CYAN 112))
      (domain-fact (name tag-matching) (param-values C-RS2 INPUT CYAN 114))
      (domain-fact (name tag-matching) (param-values C-BS INPUT CYAN 122))
      (domain-fact (name tag-matching) (param-values C-DS INPUT CYAN 132))
      (domain-fact (name tag-matching) (param-values C-SS INPUT CYAN 142))
      (domain-fact (name tag-matching) (param-values C-CS1 OUTPUT CYAN 101))
      (domain-fact (name tag-matching) (param-values C-CS2 OUTPUT CYAN 103))
      (domain-fact (name tag-matching) (param-values C-RS1 OUTPUT CYAN 111))
      (domain-fact (name tag-matching) (param-values C-RS2 OUTPUT CYAN 113))
      (domain-fact (name tag-matching) (param-values C-BS OUTPUT CYAN 121))
      (domain-fact (name tag-matching) (param-values C-DS OUTPUT CYAN 131))
      (domain-fact (name tag-matching) (param-values C-SS OUTPUT CYAN 141))

      (domain-fact (name tag-matching) (param-values M-CS1 INPUT MAGENTA 202))
      (domain-fact (name tag-matching) (param-values M-CS2 INPUT MAGENTA 204))
      (domain-fact (name tag-matching) (param-values M-RS1 INPUT MAGENTA 212))
      (domain-fact (name tag-matching) (param-values M-RS2 INPUT MAGENTA 214))
      (domain-fact (name tag-matching) (param-values M-BS INPUT MAGENTA 222))
      (domain-fact (name tag-matching) (param-values M-DS INPUT MAGENTA 232))
      (domain-fact (name tag-matching) (param-values M-SS INPUT MAGENTA 242))
      (domain-fact (name tag-matching) (param-values M-CS1 OUTPUT MAGENTA 201))
      (domain-fact (name tag-matching) (param-values M-CS2 OUTPUT MAGENTA 203))
      (domain-fact (name tag-matching) (param-values M-RS1 OUTPUT MAGENTA 211))
      (domain-fact (name tag-matching) (param-values M-RS2 OUTPUT MAGENTA 213))
      (domain-fact (name tag-matching) (param-values M-BS OUTPUT MAGENTA 221))
      (domain-fact (name tag-matching) (param-values M-DS OUTPUT MAGENTA 231))
      (domain-fact (name tag-matching) (param-values M-SS OUTPUT MAGENTA 241))
    )
  )
)
