...
" The pick-and-place-challenge was successful and the product is delivered "
	...
	(goal (class PICK-AND-PLACE) (sub-type CENTRAL-RUN-SUBGOALS-IN-PARALLEL)
	             (id ?id1) (mode FINISHED|RETRACTED)(outcome COMPLETED))
	(goal (class PICK-AND-PLACE) (sub-type CENTRAL-RUN-SUBGOALS-IN-PARALLEL)
	             (id ?id2&~?id1) (mode FINISHED|RETRACTED)(outcome COMPLETED))
	(goal (class PICK-AND-PLACE) (sub-type CENTRAL-RUN-SUBGOALS-IN-PARALLEL)
	             (id ?id3&~?id1&~?id2) (mode FINISHED|RETRACTED)(outcome COMPLETED))
	(wm-fact (key config rcll pick-and-place-challenge) (value TRUE))
	; move-wp-input-output is called in each pick-and-place thus the following facts don't hold
