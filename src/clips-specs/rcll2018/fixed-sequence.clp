...
(defrule goal-expander-prefill-cap-station
   ...
   (assert
        ...
        (plan-action (id 7) (plan-id FILL-CAP-PLAN) (goal-id ?goal-id)
                                    ...
                                    (required-resources (sym-cat ?mps -INPUT) (sym-cat ?mps -OUTPUT) ?cc))
...
(defrule goal-produce-c0
 ...
 (assert
  ...
  (plan-action (id 15) (plan-id PRODUCE-C0-PLAN) (goal-id ?goal-id)
        ...
        (required-resources (sym-cat ?mps -INPUT) (sym-cat ?mps -OUTPUT) ?spawned-wp))
...
(defrule goal-mount-first-ring
 ...
 (assert
  ...
  (plan-action (id 15) (plan-id MOUNT-FIRST-RING-PLAN) (goal-id ?goal-id)
        ...
        (required-resources ?spawned-wp (sym-cat ?mps -INPUT) (sym-cat ?mps -OUTPUT) ?spawned-wp))
 ...
 =>
    ...
    (assert
      ...
      (plan-action (id 13) (plan-id MOUNT-NEXT-RING-PLAN) (goal-id ?goal-id)
            ...
            (required-resources ?wp (sym-cat ?rs -INPUT) (sym-cat ?rs -OUTPUT)))
 ...
 =>
   (assert
    ...
    (plan-action (id 13) (plan-id PRODUCE-CX-PLAN) (goal-id ?goal-id)
          ...
          (param-names m op)
          (param-values ?mps MOUNT_CAP)
          (required-resources ?wp (sym-cat ?mps -INPUT) (sym-cat ?mps -OUTPUT)))
...
(defrule goal-deliver
 ...
 (assert
  ...
  (plan-action (id 13) (plan-id DELIVER-PLAN) (goal-id ?goal-id)
        ...
        (required-resources (sym-cat ?ds -INPUT) ?wp))
