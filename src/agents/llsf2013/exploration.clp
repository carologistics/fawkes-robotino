...
(defrule exp-config-path-clockwise
  ...
  (if (eq ?double-exploration false)
    ...
    (assert 
      ...
      (machine-exploration (name M5) (x 2.3) (y 3.1) (next M1) (look-pos M5))
...
(defrule exp-config-path-counter-clockwise
  ...
  (if (eq ?double-exploration false)
    ...
    (assert 
      ...
      (machine-exploration (name M4) (x 3.1) (y 2.13) (next M3) (look-pos M4))
    ...
    (assert
      (machine-exploration (name M8) (x 1.38) (y 2.18) (next M4) (look-pos M8))
      (machine-exploration (name M5) (x 2.3) (y 3.1) (next M8) (look-pos M5))
      (machine-exploration (name M4) (x 3.1) (y 2.13) (next M3) (look-pos M4))
      (machine-exploration (name M3) (x 3.1) (y 1.06) (next M1) (look-pos M3))
      (machine-exploration (name M1) (x 3.62) (y 1.18) (next M5) (look-pos M1))
      (first-robotino)
