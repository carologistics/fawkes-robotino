...
(deffacts startup-exploration
  (machine-exploration (name M10) (next M9) (look-pos ExpM10))
  (machine-exploration (name M9) (next M8) (look-pos ExpM9))
  (machine-exploration (name M8) (next M3) (look-pos ExpM8))
  (machine-exploration (name M7) (next M6) (look-pos ExpM7))
  (machine-exploration (name M6) (next M10) (look-pos ExpM6))
  (machine-exploration (name M5) (next M2) (look-pos ExpM5))
  (machine-exploration (name M4) (next M1) (look-pos ExpM4))
  (machine-exploration (name M3) (next M4) (look-pos ExpM3))
  (machine-exploration (name M2) (next M7) (look-pos ExpM2))
  (machine-exploration (name M1) (next M5) (look-pos ExpM1))
)
...
(deffacts startup-production
  ...
  (machine (name M9))
  (machine (name M10))
  (machine (name R1) (output S0) (mtype RECYCLE))
  (machine (name R2) (output S0) (mtype RECYCLE))
  (state WAIT_START)
  (phase PRE_GAME)
