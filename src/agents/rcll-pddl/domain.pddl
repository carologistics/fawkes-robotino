(define (domain RCLL2016)
	...
	(:action add-base-to-slide-one
		...
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(not (and (wp-in-slide ?m ONE)(wp-in-slide ?m TWO)) ) (wp-in-slide ?m ZERO)) 
		:effect
	...
	(:action add-base-to-slide-two
		:parameters ( ?r - robot ?m - ring-station ?pos - input-pos ?wp - base)
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(not (and (wp-in-slide ?m ONE)(wp-in-slide ?m TWO)) ) (wp-in-slide ?m ONE)) 
		:effect
			(and (wp-in-slide ?m TWO)(not (holding ?r ?wp)) (not-holding ?r)) 
	)
	...
	(:action move-to-position-empty
		...
		:precondition
			(and (at-pos ?r ?orig)(pos-free ?dest)(not-holding ?r)) 
		:effect
	...
	(:action move-to-position-holding
		:parameters ( ?r - robot ?orig - pos ?dest - pos)
		:precondition
			(and (at-pos ?r ?orig)(pos-free ?dest)(not (not-holding ?r)) ) 
		:effect
			(and (at-pos ?r ?dest)(not (pos-free ?dest)) (not (at-pos ?r ?orig)) (pos-free ?orig)) 
	)
	(:action pick-cc-from-shelf
		...
		:precondition
			(and (at-pos ?r ?pos)(has-pos ?m ?pos)(has-shelf-slot ?m ?ss)(cc-in-slot ?wp ?ss)(not-holding ?r)) 
		:effect
			(and (holding ?r ?wp)(not (not-holding ?r)) (not (cc-in-slot ?wp ?ss)) ) 
	)
	(:action load-cs
		:parameters ( ?r - robot ?m - cap-station ?pos - input-pos ?col - cap-color ?any-col - cap-color ?cc - cap-carrier)
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(no-cap-in-slide ?m)(has-cap ?cc ?col)(holding ?r ?cc)(idle ?m)) 
		:effect
			(and (not (holding ?r ?cc)) (not-holding ?r)(cap-in-slide ?m ?col)(not (no-cap-in-slide ?m)) (not (has-cap ?cc ?col)) (wp-in-production ?cc ?m)(not (idle ?m)) ) 
	)
	(:action add-ring-one
		...
		:precondition
			(and (idle ?m)(has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(not (has-ring-one ?wp ?ring-col)) (not (has-ring-two ?wp ?any-ring)) (not (has-cap ?wp ?any-cap)) (has-color ?wp ?base-col)(wp-in-slide ?m ?num-bases)(order-base-color ?o ?base-col)(order-ring-one ?o ?ring-col)(needs-bases ?ring-col ?num-bases)) 
		:effect
			(and (not (holding ?r ?wp)) (not-holding ?r)(wp-in-production ?wp ?m)(not (idle ?m)) (not (wp-in-slide ?m ?num-bases)) (has-ring-one ?wp ?ring-col)) 
	)
	(:action add-ring-two
		...
		:precondition
			(and (idle ?m)(has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(has-ring-one ?wp ?ring-col1)(not (has-ring-two ?wp ?ring-col2)) (not (has-ring-three ?wp ?any-ring)) (not (has-cap ?wp ?any-cap)) (has-color ?wp ?base-col)(wp-in-slide ?m ?num-bases)(order-base-color ?o ?base-col)(order-ring-one ?o ?ring-col1)(order-ring-two ?o ?ring-col2)(needs-bases ?ring-col2 ?num-bases)) 
		:effect
			(and (not (holding ?r ?wp)) (not-holding ?r)(wp-in-production ?wp ?m)(not (idle ?m)) (not (wp-in-slide ?m ?num-bases)) (has-ring-two ?wp ?ring-col2)) 
	)
	(:action add-ring-three
		...
		:precondition
			(and (idle ?m)(has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(has-ring-one ?wp ?ring-col1)(has-ring-two ?wp ?ring-col2)(not (has-ring-three ?wp ?ring-col3)) (not (has-cap ?wp ?any-cap)) (has-color ?wp ?base-col)(wp-in-slide ?m ?num-bases)(order-base-color ?o ?base-col)(order-ring-one ?o ?ring-col1)(order-ring-two ?o ?ring-col2)(order-ring-three ?o ?ring-col3)(needs-bases ?ring-col3 ?num-bases)) 
		:effect
			(and (not (holding ?r ?wp)) (not-holding ?r)(wp-in-production ?wp ?m)(not (idle ?m)) (not (wp-in-slide ?m ?num-bases)) (has-ring-three ?wp ?ring-col3)) 
	)
	...
	(:action prod-at-cs
		...
		:precondition
			(and (idle ?m)(has-pos ?m ?pos)(at-pos ?r ?pos)(holding ?r ?wp)(not (has-cap ?wp ?any-cap)) (has-color ?wp ?base-col)(cap-in-slide ?m ?cap-col)(order-base-color ?o ?base-col)(order-cap-color ?o ?cap-col)) 
		:effect
			(and (wp-in-production ?wp ?m)(not (idle ?m)) (not (holding ?r ?wp)) (not-holding ?r)(not (cap-in-slide ?m ?cap-col)) (no-cap-in-slide ?m)(has-cap ?wp ?cap-col)) 
	)
	(:action pick-wp-from-cs
		:parameters ( ?r - robot ?m - cap-station ?pos - output-pos ?wp - workpiece ?any - workpiece)
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(wp-in-production ?wp ?m)(not-holding ?r)) 
		:effect
			(and (not (wp-in-production ?wp ?m)) (idle ?m)(holding ?r ?wp)(not (not-holding ?r)) ) 
	)
	...
	(:action pick-wp-from-bs
		...
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(wp-at-bs ?wp)(not-holding ?r)) 
		:effect
			(and (holding ?r ?wp)(not (not-holding ?r)) (not (wp-at-bs ?wp)) ) 
	)
	(:action deliver-c0
		:parameters ( ?r - robot ?m - delivery-station ?pos - input-pos ?wp - base ?base-col - base-color ?cap-col - cap-color ?o - order)
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(has-color ?wp ?base-col)(has-cap ?wp ?cap-col)(holding ?r ?wp)(order-complexity ?o C0)(order-base-color ?o ?base-col)(order-cap-color ?o ?cap-col)) 
		:effect
			(and (order-fulfilled ?o)(not (holding ?r ?wp)) (not-holding ?r)(not (has-cap ?wp ?cap-col)) (not (has-color ?wp ?base-col)) ) 
	)
	(:action deliver-c1
		...
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(has-color ?wp ?base-col)(has-cap ?wp ?cap-col)(has-ring-one ?wp ?ring-col1)(holding ?r ?wp)(order-complexity ?o C1)(order-base-color ?o ?base-col)(order-cap-color ?o ?cap-col)(order-ring-one ?o ?ring-col1)) 
		:effect
			(and (order-fulfilled ?o)(not (holding ?r ?wp)) (not-holding ?r)(not (has-cap ?wp ?cap-col)) (not (has-color ?wp ?base-col)) (not (has-ring-one ?wp ?ring-col1)) ) 
	)
	(:action deliver-c2
		...
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(has-color ?wp ?base-col)(has-cap ?wp ?cap-col)(has-ring-one ?wp ?ring-col1)(has-ring-two ?wp ?ring-col2)(holding ?r ?wp)(order-complexity ?o C2)(order-base-color ?o ?base-col)(order-cap-color ?o ?cap-col)(order-ring-one ?o ?ring-col1)(order-ring-two ?o ?ring-col2)) 
		:effect
			(and (order-fulfilled ?o)(not (holding ?r ?wp)) (not-holding ?r)(not (has-cap ?wp ?cap-col)) (not (has-color ?wp ?base-col)) (not (has-ring-one ?wp ?ring-col1)) (not (has-ring-two ?wp ?ring-col2)) ) 
	)
	(:action deliver-c3
		...
		:precondition
			(and (has-pos ?m ?pos)(at-pos ?r ?pos)(has-color ?wp ?base-col)(has-cap ?wp ?cap-col)(has-ring-one ?wp ?ring-col1)(has-ring-two ?wp ?ring-col2)(has-ring-three ?wp ?ring-col3)(holding ?r ?wp)(order-complexity ?o C3)(order-base-color ?o ?base-col)(order-cap-color ?o ?cap-col)(order-ring-one ?o ?ring-col1)(order-ring-two ?o ?ring-col2)(order-ring-three ?o ?ring-col3)) 
		:effect
			(and (order-fulfilled ?o)(not (holding ?r ?wp)) (not-holding ?r)(not (has-cap ?wp ?cap-col)) (not (has-color ?wp ?base-col)) (not (has-ring-one ?wp ?ring-col1)) (not (has-ring-two ?wp ?ring-col2)) (not (has-ring-three ?wp ?ring-col3)) ) 
	)
)