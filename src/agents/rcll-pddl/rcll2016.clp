...
(path-load  rcll-pddl/priorities.clp)
(path-load  rcll-pddl/globals.clp)
(path-load  rcll-pddl/facts.clp)
...
(defrule enable-blackboard
  ...
  (path-load "rcll-pddl/blackboard-init.clp")
)
...
(defrule enable-navgraph
  ...
  (path-load  rcll-pddl/navgraph.clp)
)
...
(defrule initialize
  ...
  (ff-feature navgraph)
  =>
  (path-load  rcll-pddl/utils.clp)
  (path-load  rcll-pddl/robot-memory.clp)
  (path-load  rcll-pddl/worldmodel-synchronization.clp)
  (path-load  rcll-pddl/net.clp)
  (path-load  rcll-pddl/worldmodel.clp)
  (path-load  rcll-pddl/skills.clp)
  (path-load  rcll-pddl/lock-managing.clp)
  (path-load  rcll-pddl/lock-usage.clp)
  (if
  ...
  then
    ...
    (path-load  rcll-pddl/sim.clp)
  )
  (path-load  rcll-pddl/game.clp)
  (path-load  rcll-pddl/mps-instructions.clp)
