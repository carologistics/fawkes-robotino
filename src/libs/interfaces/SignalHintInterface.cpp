...
SignalHintInterface::SignalHintInterface() : Interface()
{
  ...
  unsigned char tmp_hash[] = {0x86, 0x5e, 0x2d, 0xee, 0xa, 0x55, 0xbf, 0x4b, 0x7e, 0xd2, 0x15, 0xaf, 0x8b, 0x4a, 0x56, 0x4c};
  set_hash(tmp_hash);
}
...
/** Get translation value.
 * 
			Expected position of the signal, relative to the front-top-left corner
			of the MPS.
