...
depends_skills     = {"move_under_rfid","determine_signal","leave_area"}
depends_interfaces = {
...
function signal_not_green()
	return not signal_green
end
...
fsm:add_transitions{
  ...
  {"IS_CHECKED_D1","DELIVERED", cond = signal_green},
  {"IS_CHECKED_D1","MOVE_TO_D2", cond = signal_not_green},
  ...
  {"IS_CHECKED_D2","DELIVERED", cond = signal_green},
  {"IS_CHECKED_D2","MOVE_TO_D3", cond = signal_not_green},
  ...
  {"IS_CHECKED_D3","DELIVERED", cond = signal_green, fail_to="FAILED"},
