...
fsm:define_states{ export_to=_M, closure={gripper_if=gripper_if},
   ...
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_XY"},
   {"MOVE_GRIPPER_XY", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_XY", fail_to="FAILED"},
