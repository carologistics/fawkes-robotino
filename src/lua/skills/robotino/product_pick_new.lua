...
depends_skills     = {"gripper_commands", "approach_mps"}
depends_interfaces = {
...
fsm:define_states{ export_to=_M, closure={gripper_if=gripper_if},
   ...
   {"ADJUST_GRIPPER", SkillJumpState,skills{{gripper_commands}},final_to="CHECK_VISION",fail_to="FAIL"},
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="MOVE_GRIPPER", fail_to="FAIL"},
   {"MOVE_GRIPPER_XY", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_Z",fail_to="FAIL"},
   {"MOVE_GRIPPER_Z", SkillJumpState, skills={{gripper_commands}}, final_to="CLOSE_GRIPPER",fail_to="FAIL"},
   {"CLOSE_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to = "MOVE_GRIPPER_BACK", fail_to="FAIL"},
   {"MOVE_GRIPPER_BACK", SkillJumpState, skills={{gripper_commands}}, final_to = "DRIVE_BACK", fail_to="FAIL"},
...
function MOVE_GRIPPER_XY:init()
  self.args["gripper_commands"].x = gripper_x
  self.args["gripper_commands"].y = gripper_y
  self.args["gripper_commands"].command = "MOVEABS"
end

function MOVE_GRIPPER_Z:init()
  self.args["gripper_commands"].z = gripper_z
  self.args["gripper_commands"].command = "MOVEABS"
end
...
function MOVE_GRIPPER_BACK:init()
  self.args["gripper_commands"].z = gripper_back_z
  self.args["gripper_commands"].command = "MOVEABS"
end
