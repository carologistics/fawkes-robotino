...
fsm:define_states{ export_to=_M, closure={gripper_if=gripper_if},
   ...
   {"ADJUST_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="CHECK_VISION",fail_to="FAILED"},
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="MOVE_GRIPPER_XY", fail_to="FAILED"},
   {"MOVE_GRIPPER_XY", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_Z",fail_to="FAILED"},
   {"MOVE_GRIPPER_Z", SkillJumpState, skills={{gripper_commands}}, final_to="CLOSE_GRIPPER",fail_to="FAILED"},
