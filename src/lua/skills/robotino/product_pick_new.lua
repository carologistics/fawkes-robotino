...
--   {"ADJUST_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="CHECK_VISION",fail_to="FAILED"},
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="MOVE_GRIPPER_YZ", fail_to="FAILED"},
   {"MOVE_GRIPPER_YZ", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_X",fail_to="FAILED"},
   {"MOVE_GRIPPER_X", SkillJumpState, skills={{gripper_commands}}, final_to="CLOSE_GRIPPER",fail_to="FAILED"},
...
function MOVE_GRIPPER_YZ:init()
  self.args["gripper_commands"].x = gripper_z
  self.args["gripper_commands"].y = gripper_y
  self.args["gripper_commands"].command = "MOVEABS"
end

function MOVE_GRIPPER_X:init()
  self.args["gripper_commands"].z = gripper_x
  self.args["gripper_commands"].command = "MOVEABS"
end
