...
fsm:define_states{ export_to=_M,
   {"INIT", JumpState},
   {"MOVE_GRIPPER_YZ", SkillJumpState, skills={{gripper_commands}},final_to="MOVE_GRIPPER_X",FAILED},
   {"MOVE_GRIPPER_X", SkillJumpState, skills={{gripper_commands}}, final_to="OPEN_GRIPPER","FAILED"},
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to="WAIT", fail_to="FAILED"},
   {"WAIT", JumpState},
