...
fsm:define_states{ export_to=_M,
  ...
  {"MOVE_GRIPPER_DOWN", SkillJumpState, skills={{gripper_commands}}, final_to="OPEN_GRIPPER", fail_to="CLEANUP_FAILED"},
  {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_BACK", fail_to="CLEANUP_FAILED"},
  {"MOVE_GRIPPER_BACK", SkillJumpState, skills={{gripper_commands}}, final_to = "DRIVE_BACK", fail_to="CLEANUP_FAILED"},
  {"DRIVE_BACK", SkillJumpState, skills={{motor_move}}, final_to="CLOSE_GRIPPER", fail_to="CLEANUP_FAILED"},
  {"CLOSE_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to="CLEANUP_FINAL", fail_to="CLEANUP_FAILED"},
