...
local gripper_down_z_put = -0.01  -- distance to move gripper down after driving over product

local gripper_up_z_pick = 0.01   -- distance to move gripper up after closing gripper
local gripper_up_z_put = 0.008   -- distance to move gripper up after opening gripper
