...
--  self.args["gripper_commands"].command = "MOVEABS"
  self.args["gripper_commands"].x = self.fsm.vars.gripper_x
  self.args["gripper_commands"].y = self.fsm.vars.gripper_y
  self.args["gripper_commands"].z = self.fsm.vars.gripper_z
end
