...
fsm:define_states{ export_to=_M, closure={gripper_if=gripper_if},
   ...
   {"MOVE_GRIPPER_FORWARD", SkillJumpState, skills={{gripper_commands}}, final_to="CLOSE_GRIPPER",fail_to="CLEANUP_FAILED"},
   {"CLOSE_GRIPPER", SkillJumpState, skills={{gripper_commands}}, final_to="MOVE_GRIPPER_BACK", fail_to="CLEANUP_FAILED"},
