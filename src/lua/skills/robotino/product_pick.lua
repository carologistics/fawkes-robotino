...
local conveyor_gripper_forward_x = 0.06 -- distance to move gripper forward after align
...
local gripper_pose_offset_z = 0.07  -- conveyor_pose offset in z direction
...
fsm:define_states{ export_to=_M, closure={gripper_if=gripper_if},
   ...
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="CHECK_VISION", fail_to="FAILED"},
   {"CHECK_VISION", JumpState},
   {"GRIPPER_ALIGN", SkillJumpState, skills={{gripper_commands}}, final_to="CHECK_TOLERANCE",fail_to="FAILED"},
   ...
   {"MOVE_GRIPPER_BACK", SkillJumpState, skills={{gripper_commands}}, final_to = "HOME_GRIPPER", fail_to="FAILED"},
