...
fsm:define_states{ export_to=_M,
   ...
   {"OPEN_GRIPPER", SkillJumpState, skills={{gripper_commands}},final_to="CHECK_VISION", fail_to="PRE_FAIL"},
   {"CHECK_VISION", JumpState},
   {"GRIPPER_ALIGN", SkillJumpState, skills={{gripper_commands}}, final_to="DECIDE_RETRY",fail_to="PRE_FAIL"},
