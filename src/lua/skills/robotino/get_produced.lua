...
fsm:add_transitions{
   ...
   {"CHECK_PRODUCE", "WAIT", cond = producing, desc = "Wait until the Product is finished"},
   {"WAIT", "TURN", cond = "not producing()", desc = "The product is finished"},
   {"WAIT", "FAILED", timeout = 62, desc = "Can't read the light properly"},
