...
function finished() return fsm.vars.nr_puts == 3 end
...
function END_POS:exit()
    ...
    print_info("[VS] Execution time for mps " .. fsm.vars.mps .. ": " .. now -
                   fsm.vars.time_start)
end
