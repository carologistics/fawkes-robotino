...
depends_skills = {
    "mps_align", "product_put", "product_pick", "shelf_pick", "conveyor_align"
}
depends_interfaces = {}
...
fsm:define_states{
    ...
    {"INIT", JumpState},
    {
        ...
        SkillJumpState,
        skills = {{mps_align}},
        final_to = "DECIDE_WAIT_MPS_ALIGN",
        fail_to = "FAILED"
    },
    {
        "CONVEYOR_ALIGN",
        ...
        final_to = "DECIDE_WAIT_CONVEYOR_ALIGN",
        fail_to = "FAILED"
    },
...
fsm:add_transitions{
    ...
    {"WAIT_CONVEYOR_ALIGN", "DECIDE_ENDSKILL", timeout = 2}, {
        ...
        "SKILL_SHELF_PICK",
        cond = "vars.shelf",
        desc = "Pick from shelf"
    }, {
        "DECIDE_ENDSKILL",
        "SKILL_PRODUCT_PUT",
        cond = "vars.action=='PUT'",
        desc = "Put on conveyor or slide"
    }, {
        "DECIDE_ENDSKILL",
        "SKILL_PRODUCT_PICK",
        cond = "vars.action=='PICK'",
        desc = "Pick from conveyor"
    },
    {
        "DECIDE_ENDSKILL",
        "FAILED",
        cond = "true",
        desc = "action was not correct"
    }
}

function INIT:init()
    -- make everything explicit
    if self.fsm.vars.shelf ~= nil then self.fsm.vars.action = "PICK" end
