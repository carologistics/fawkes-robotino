...
skillenv.use_skill("skills.robotino.gripper_z_align")
...
skillenv.use_skill("skills.robotino.gripper_commands_new")
...
skillenv.use_skill("skills.robotino.shelf_pick_new")
skillenv.use_skill("skills.robotino.slide_put")
skillenv.use_skill("skills.robotino.slide_put_new")
skillenv.use_skill("skills.robotino.shelf_put")
skillenv.use_skill("skills.robotino.product_pick")
skillenv.use_skill("skills.robotino.product_pick_new")
skillenv.use_skill("skills.robotino.product_put")
skillenv.use_skill("skills.robotino.drive_to_machine_point")
skillenv.use_skill("skills.robotino.product_put_new")
skillenv.use_skill("skills.robotino.bring_product_to")
skillenv.use_skill("skills.robotino.bring_product_to_new")
skillenv.use_skill("skills.robotino.bring_product_to_general")
skillenv.use_skill("skills.robotino.get_product_from")
skillenv.use_skill("skills.robotino.get_product_from_new")
skillenv.use_skill("skills.robotino.get_product_from_general")
