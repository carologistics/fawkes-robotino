...
skillenv.use_skill("skills.robotino.get_rid_of_puck")
...
skillenv.use_skill("skills.robotino.get_produced")
...
skillenv.use_skill("skills.robotino.drive_to_via")
