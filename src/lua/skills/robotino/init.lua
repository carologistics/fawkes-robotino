...
skillenv.use_skill("skills.robotino.mps_recog_side")
skillenv.use_skill("skills.robotino.tagless_mps_align")
skillenv.use_skill("skills.robotino.approach_test")
skillenv.use_skill("skills.robotino.tagless_bring_product")
skillenv.use_skill("skills.robotino.tagless_get_product")
skillenv.use_skill("skills.robotino.tagless_production")
