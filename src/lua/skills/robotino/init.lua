...
skillenv.use_skill("skills.robotino.mps_recog")
skillenv.use_skill("skills.robotino.tagless_mps_align")
skillenv.use_skill("skills.robotino.recog_from_align")
skillenv.use_skill("skills.robotino.zone_recog")
skillenv.use_skill("skills.robotino.zone_recog_improved")  
skillenv.use_skill("skills.robotino.recog_in_two_zones")
