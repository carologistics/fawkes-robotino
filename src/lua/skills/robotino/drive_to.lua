...
fsm:define_states{ export_to=_M,
  ...
  {"INIT",                     JumpState},
  {"SKILL_PPGOTO",             SkillJumpState, skills={{ppmoveto}},            final_to="TIMEOUT", fail_to="FORCE_SET_JUST_ORI"},
...
function SKILL_PPGOTO:init()
	 self.args["ppmoveto"] = {x = self.fsm.vars.x, y = self.fsm.vars.y, ori = self.fsm.vars.ori}
end
