...
depends_skills = {"ppmoveto", "global_motor_move"}
depends_interfaces = {}

documentation =
    [==[Drive to point with colisoin avoidance and last part with global_motor_move
...
Parameters:
      ...
      just_ori:     if true => after ppmoveto finished, global_motor_move is just called with ori (for exploration)
]==]
...
fsm:define_states{
    ...
    {"INIT", JumpState},
    {
        ...
        skills = {{ppmoveto}},
        final_to = "TIMEOUT",
        fail_to = "FORCE_SET_JUST_ORI"
    },
    {"FORCE_SET_JUST_ORI", JumpState},
    {"TIMEOUT", JumpState},
    {
        "SKILL_GLOBAL_MOTOR_MOVE",
        SkillJumpState,
        skills = {{global_motor_move}},
        final_to = "FINAL",
        fail_to = "FINAL"
    }
}
