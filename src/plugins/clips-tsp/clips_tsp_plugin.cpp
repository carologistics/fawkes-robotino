 ...
 */
class ClipsTSPPlugin : public fawkes::Plugin
{
public:
	/** Constructor.
   * @param config Fawkes configuration
   */
	explicit ClipsTSPPlugin(Configuration *config) : Plugin(config)
	{
		thread_list.push_back(new ClipsTSPThread());
	}
};

PLUGIN_DESCRIPTION("CLIPS feature to access the NavGraph")
EXPORT_PLUGIN(ClipsTSPPlugin)
