#ifndef __GENERIC_BRIDGE_MANAGER_H_
#define __GENERIC_BRIDGE_MANAGER_H_
...
class GenericBridgeManager
: public  IbridgeManager,
  public std::enable_shared_from_this<GenericBridgeManager>
{
	public:
