...
,	public std::enable_shared_from_this<Advertisment>
{
	...
	protected:
		/** @brief the possible status of an instance. A DORMANT instance only keeps the data.*/
		...
		struct 			Request
						{
							...
							{}
							~Request(){};
							std::string		id;		/**< id given to request. Unique across a single advertisement instance*/
						};
