...
namespace gazebo
{
   ...
   */
  class ConveyorVision: public SimDevice
  {
  public:

    //Constructor
    ConveyorVision(physics::ModelPtr, transport::NodePtr);
    ///Destructor
    ~ConveyorVision();  
  ...
  private:
    ...
    void send_conveyor_position();

    ///Publisher for light results
    transport::PublisherPtr conveyor_position_pub_;
