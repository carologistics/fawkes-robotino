...
TagVisionThread::init()
{
	...
	case ALVAR:
		...
		break;
	case ARUCO:
		cameraMatrix_ = (cv::Mat_<double>(3, 3) << 1.34054730e+03, 0.00000000e+00, 7.76638142e+02, 0.00000000e+00, 1.34916523e+03, 6.00950522e+02, 0.00000000e+00, 0.00000000e+00, 1.00000000e+00);
		distCoeffs_   = (cv::Mat_<double>(1, 5) << 0.06067995, -0.14242907,  0.00709476, -0.00440269,  0.04458921);
