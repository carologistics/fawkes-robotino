 ...
 */
TagPositionInterfaceHelper::TagPositionInterfaceHelper(fawkes::Position3DInterface *position_interface, u_int32_t vector_position, fawkes::BlackBoard *blackboard, fawkes::Clock *clock) :
