...
class RobotinoOmniVisionPlugin : public fawkes::Plugin
{
 public:
    ...
    : Plugin(config)
  {
    ...
    OmniVisionSensorThread *s = new OmniVisionSensorThread(t);
    thread_list.push_back(t);
    thread_list.push_back(s);
  }
};

PLUGIN_DESCRIPTION("Robotino omni-vision image processing with a new thread")
