 ...
 */
const char * MPSRecognitionInterface::tostring_MPSType(MPSType value) const {
 ...
 * @return msgid value
 */
uint32_t MPSRecognitionInterface::msgid() const {
 ...
 */
size_t MPSRecognitionInterface::maxlenof_msgid() const {
 ...
 */
void MPSRecognitionInterface::set_msgid(const uint32_t new_msgid) {
 ...
 *  @return final value
 */
bool MPSRecognitionInterface::is_final() const {
 ...
 * maximum number of characters for a string
 */
size_t MPSRecognitionInterface::maxlenof_final() const {
 ...
 */
void MPSRecognitionInterface::set_final(const bool new_final) {
...
MPSRecognitionInterface::MPSType MPSRecognitionInterface::mpstype() const {
 ...
 * maximum number of characters for a string
 */
size_t MPSRecognitionInterface::maxlenof_mpstype() const {
 ...
 */
void MPSRecognitionInterface::set_mpstype(const MPSType new_mpstype) {
...
Message * MPSRecognitionInterface::create_message(const char *type) const {
 ...
 */
void MPSRecognitionInterface::copy_values(const Interface *other) {
...
const char * MPSRecognitionInterface::enum_tostring(const char *enumtype, int val) const{
 ...
 */
Message * MPSRecognitionInterface::ClearMessage::clone() const {
 ...
 * @return clone of this message
 */
Message * MPSRecognitionInterface::ComputeMessage::clone() const {
 ...
 */
bool MPSRecognitionInterface::message_valid(const Message *message) const { 
