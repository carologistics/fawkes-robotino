...
void LightCompassThread::init()
{
	...
	this->cspace_from_ = this->cam_->colorspace();
		...
		this->colorModel_ = new firevision::ColorModelRange( 	cfg_color_y_min, cfg_color_y_max,
																cfg_color_u_min, cfg_color_u_max,
																cfg_color_v_min, cfg_color_v_max);

		this->classifierExpected_ = new firevision::SimpleColorClassifier(
	...
	// SHM image buffer
	this->shm_buffer_filtered = new firevision::SharedMemoryImageBuffer(shmID.c_str(), this->cspace_to_,
