...
Blob::Blob(unsigned char* buffer, int buffer_width, int buffer_height,
		...
		buffer_(buffer), buffer_width_(buffer_width), buffer_height_(
				buffer_height), threshold_(threshold), center_x_(x), center_y_(
				y) {
	lower_y_ = center_y_;
	upper_y_ = center_y_;
...
int Blob::getLeftX() const {
	return left_x_;
}

int Blob::getLowerY() const {
	return lower_y_;
}

int Blob::getRightX() const {
	return right_x_;
}

int Blob::getUpperY() const {
	return upper_y_;
}

void Blob::setLeftX(int leftX) {
	left_x_ = leftX;
}

void Blob::setLowerY(int lowerY) {
	lower_y_ = lowerY;
}

void Blob::setRightX(int rightX) {
	right_x_ = rightX;
}

void Blob::setUpperY(int upperY) {
	upper_y_ = upperY;
}
