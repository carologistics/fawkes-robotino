...
bool  OdometryThread::prepare_finalize_user() {
	return true;
}

void  OdometryThread::finalize() {
	blackboard->close(motor_if_);
	__pub.shutdown();
}

nav_msgs::Odometry  OdometryThread::createOdometryMessage() {
	//Odometry Message
...
void  OdometryThread::sendOdometryToROS() {
	//Odometry Message
