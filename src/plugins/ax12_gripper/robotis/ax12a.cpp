...
/***************************************************************************
 *  ax12a.cpp - Controller Robotis AX12 - Servos
 *
 *  Created: Mon Feb 09 16:53:39 2015 (based on visca.cpp)
...
const float         RobotisAX12A::MAX_ANGLE_RAD            = fawkes::deg2rad(RobotisAX12A::MAX_ANGLE_DEG); /**< MAX_ANGLE_RAD */
const float         RobotisAX12A::RAD_PER_POS_TICK         = RobotisAX12A::MAX_ANGLE_RAD / (float)(RobotisAX12A::MAX_POSITION); /**< RAD_PER_POS_TICK */
const float         RobotisAX12A::POS_TICKS_PER_RAD        = (float)(RobotisAX12A::MAX_POSITION) / RobotisAX12A::MAX_ANGLE_RAD; /**< POS_TICKS_PER_RAD */
const float         RobotisAX12A::SEC_PER_60DEG_12V        = 0.167; /**< SEC_PER_60DEG_12V */
const float         RobotisAX12A::SEC_PER_60DEG_16V        = 0.126; /**< SEC_PER_60DEG_16V */

const unsigned char RobotisAX12A::SRL_RESPOND_NONE         =  0; /**< SRL_RESPOND_NONE */
const unsigned char RobotisAX12A::SRL_RESPOND_READ         =  1; /**< SRL_RESPOND_READ */
const unsigned char RobotisAX12A::SRL_RESPOND_ALL          =  2; /**< SRL_RESPOND_ALL */

const unsigned char RobotisAX12A::P_MODEL_NUMBER_L         =  0; /**< P_MODEL_NUMBER_L */
const unsigned char RobotisAX12A::P_MODEL_NUMBER_H         =  1; /**< P_MODEL_NUMBER_H */
const unsigned char RobotisAX12A::P_VERSION                =  2; /**< P_VERSION */
const unsigned char RobotisAX12A::P_ID                     =  3; /**< P_ID */
const unsigned char RobotisAX12A::P_BAUD_RATE              =  4; /**< P_BAUD_RATE */
const unsigned char RobotisAX12A::P_RETURN_DELAY_TIME      =  5; /**< P_RETURN_DELAY_TIME */
const unsigned char RobotisAX12A::P_CW_ANGLE_LIMIT_L       =  6; /**< P_CW_ANGLE_LIMIT_L */
const unsigned char RobotisAX12A::P_CW_ANGLE_LIMIT_H       =  7; /**< P_CW_ANGLE_LIMIT_H */
const unsigned char RobotisAX12A::P_CCW_ANGLE_LIMIT_L      =  8; /**< P_CCW_ANGLE_LIMIT_L */
const unsigned char RobotisAX12A::P_CCW_ANGLE_LIMIT_H      =  9; /**< P_CCW_ANGLE_LIMIT_H */
const unsigned char RobotisAX12A::P_SYSTEM_DATA2           = 10; /**< P_SYSTEM_DATA2 */
const unsigned char RobotisAX12A::P_LIMIT_TEMPERATURE      = 11; /**< P_LIMIT_TEMPERATURE */
const unsigned char RobotisAX12A::P_DOWN_LIMIT_VOLTAGE     = 12; /**< P_DOWN_LIMIT_VOLTAGE */
const unsigned char RobotisAX12A::P_UP_LIMIT_VOLTAGE       = 13; /**< P_UP_LIMIT_VOLTAGE */
const unsigned char RobotisAX12A::P_MAX_TORQUE_L           = 14; /**< P_MAX_TORQUE_L */
const unsigned char RobotisAX12A::P_MAX_TORQUE_H           = 15; /**< P_MAX_TORQUE_H */
const unsigned char RobotisAX12A::P_RETURN_LEVEL           = 16; /**< P_RETURN_LEVEL */
const unsigned char RobotisAX12A::P_ALARM_LED              = 17; /**< P_ALARM_LED */
const unsigned char RobotisAX12A::P_ALARM_SHUTDOWN         = 18; /**< P_ALARM_SHUTDOWN */
const unsigned char RobotisAX12A::P_OPERATING_MODE         = 19; /**< P_OPERATING_MODE */
const unsigned char RobotisAX12A::P_DOWN_CALIBRATION_L     = 20; /**< P_DOWN_CALIBRATION_L */
const unsigned char RobotisAX12A::P_DOWN_CALIBRATION_H     = 21; /**< P_DOWN_CALIBRATION_H */
const unsigned char RobotisAX12A::P_UP_CALIBRATION_L       = 22; /**< P_UP_CALIBRATION_L */
const unsigned char RobotisAX12A::P_UP_CALIBRATION_H       = 23; /**< P_UP_CALIBRATION_H */

const unsigned char RobotisAX12A::P_TORQUE_ENABLE          = 24; /**< P_TORQUE_ENABLE */
const unsigned char RobotisAX12A::P_LED                    = 25; /**< P_LED */
const unsigned char RobotisAX12A::P_CW_COMPLIANCE_MARGIN   = 26; /**< P_CW_COMPLIANCE_MARGIN */
const unsigned char RobotisAX12A::P_CCW_COMPLIANCE_MARGIN  = 27; /**< P_CCW_COMPLIANCE_MARGIN */
const unsigned char RobotisAX12A::P_CW_COMPLIANCE_SLOPE    = 28; /**< P_CW_COMPLIANCE_SLOPE */
const unsigned char RobotisAX12A::P_CCW_COMPLIANCE_SLOPE   = 29; /**< P_CCW_COMPLIANCE_SLOPE */
const unsigned char RobotisAX12A::P_GOAL_POSITION_L        = 30; /**< P_GOAL_POSITION_L */
const unsigned char RobotisAX12A::P_GOAL_POSITION_H        = 31; /**< P_GOAL_POSITION_H */
const unsigned char RobotisAX12A::P_GOAL_SPEED_L           = 32; /**< P_GOAL_SPEED_L */
const unsigned char RobotisAX12A::P_GOAL_SPEED_H           = 33; /**< P_GOAL_SPEED_H */
const unsigned char RobotisAX12A::P_TORQUE_LIMIT_L         = 34; /**< P_TORQUE_LIMIT_L */
const unsigned char RobotisAX12A::P_TORQUE_LIMIT_H         = 35; /**< P_TORQUE_LIMIT_H */
const unsigned char RobotisAX12A::P_PRESENT_POSITION_L     = 36; /**< P_PRESENT_POSITION_L */
const unsigned char RobotisAX12A::P_PRESENT_POSITION_H     = 37; /**< P_PRESENT_POSITION_H */
const unsigned char RobotisAX12A::P_PRESENT_SPEED_L        = 38; /**< P_PRESENT_SPEED_L */
const unsigned char RobotisAX12A::P_PRESENT_SPEED_H        = 39; /**< P_PRESENT_SPEED_H */
const unsigned char RobotisAX12A::P_PRESENT_LOAD_L         = 40; /**< P_PRESENT_LOAD_L */
const unsigned char RobotisAX12A::P_PRESENT_LOAD_H         = 41; /**< P_PRESENT_LOAD_H */
const unsigned char RobotisAX12A::P_PRESENT_VOLTAGE        = 42; /**< P_PRESENT_VOLTAGE */
const unsigned char RobotisAX12A::P_PRESENT_TEMPERATURE    = 43; /**< P_PRESENT_TEMPERATURE */
const unsigned char RobotisAX12A::P_REGISTERED_INSTRUCTION = 44; /**< P_REGISTERED_INSTRUCTION */
const unsigned char RobotisAX12A::P_PAUSE_TIME             = 45; /**< P_PAUSE_TIME */
const unsigned char RobotisAX12A::P_MOVING                 = 46; /**< P_MOVING */
const unsigned char RobotisAX12A::P_LOCK                   = 47; /**< P_LOCK */
const unsigned char RobotisAX12A::P_PUNCH_L                = 48; /**< P_PUNCH_L */
const unsigned char RobotisAX12A::P_PUNCH_H                = 49; /**< P_PUNCH_H */

//--- Instructions ---
const unsigned char RobotisAX12A::INST_PING                = 0x01; /**< INST_PING */
const unsigned char RobotisAX12A::INST_READ                = 0x02; /**< INST_READ */
const unsigned char RobotisAX12A::INST_WRITE               = 0x03; /**< INST_WRITE */
const unsigned char RobotisAX12A::INST_REG_WRITE           = 0x04; /**< INST_REG_WRITE */
const unsigned char RobotisAX12A::INST_ACTION              = 0x05; /**< INST_ACTION */
const unsigned char RobotisAX12A::INST_RESET               = 0x06; /**< INST_RESET */
const unsigned char RobotisAX12A::INST_DIGITAL_RESET       = 0x07; /**< INST_DIGITAL_RESET */
const unsigned char RobotisAX12A::INST_SYSTEM_READ         = 0x0C; /**< INST_SYSTEM_READ */
const unsigned char RobotisAX12A::INST_SYSTEM_WRITE        = 0x0D; /**< INST_SYSTEM_WRITE */
const unsigned char RobotisAX12A::INST_SYNC_WRITE          = 0x83; /**< INST_SYNC_WRITE */
const unsigned char RobotisAX12A::INST_SYNC_REG_WRITE      = 0x84; /**< INST_SYNC_REG_WRITE */

const unsigned char RobotisAX12A::PACKET_OFFSET_ID         = 2; /**< PACKET_OFFSET_ID */
const unsigned char RobotisAX12A::PACKET_OFFSET_LENGTH     = 3; /**< PACKET_OFFSET_LENGTH */
const unsigned char RobotisAX12A::PACKET_OFFSET_INST       = 4; /**< PACKET_OFFSET_INST */
const unsigned char RobotisAX12A::PACKET_OFFSET_PARAM      = 5; /**< PACKET_OFFSET_PARAM */
const unsigned char RobotisAX12A::PACKET_OFFSET_ERROR      = 4; /**< PACKET_OFFSET_ERROR */

using namespace std;
using namespace fawkes;


/** @class RobotisAX12A "ax12a.h"
 * Class to access a chain of Robotis AX12A servos.
 ...
 * @code
 * ax12a->set_status_return_level(RobotisAX12A::BROADCAST_ID, RobotisAX12A::SRL_RESPOND_READ);
 * @endcode
 *
 ...
 */
RobotisAX12A::RobotisAX12A(const char *device_file, unsigned int default_timeout_ms)
{
  ...
  __obuffer_length     = 0;
  __ibuffer_length     = 0;
  memset(__control_table, 0, AX12A_MAX_NUM_SERVOS * AX12A_CONTROL_TABLE_LENGTH);
  try {
    open();
  } catch (Exception &e) {
    free(__device_file);
 ...
 * @return checksum as defined in the AX12A manual
 */
unsigned char
RobotisAX12A::calc_checksum(const unsigned char id, const unsigned char instruction,
 ...
 */
void
RobotisAX12A::send(const unsigned char id, const unsigned char instruction,
		  const unsigned char *params, const unsigned char plength)
{
...
#ifdef DEBUG_AX12A_COMM
  printf("send: id: %d, length: %d, instruction: %d, ", id, plength + 2, instruction);
#endif
...
#ifdef DEBUG_AX12A_COMM
  printf(" checksum: %d", calc_checksum(id, instruction, params, plength));
  ...
  */
  if ( written < 0 ) {
    throw Exception(errno, "Failed to write AX12A packet %x for %x", instruction, id);
  } else if (written < __obuffer_length) {
    throw Exception("Failed to write AX12A packet %x for %x, only %d of %d bytes sent",
 ...
 */
void
RobotisAX12A::recv(const unsigned char exp_length, unsigned int timeout_ms)
{
  ...
  if ( rv == -1 ) {
   throw Exception(errno, "Select on FD failed");
    ...
    throw TimeoutException("Timeout reached while waiting for incoming AX12A data");
  }
 ...
 * AX12A_MAX_NUM_SERVOS receive operations, each with the given timeout. After the
 ...
 */
RobotisAX12A::DeviceList
RobotisAX12A::discover(unsigned int timeout_ms)
{
  DeviceList rv;
  ...
  for (unsigned int i = 0; i < AX12A_MAX_NUM_SERVOS; ++i) {
    try {
      // printf("Trying receive for %u\n", i);
      recv(0, timeout_ms);
      // printf("Pushing %u\n", __ibuffer[PACKET_OFFSET_ID]);
  ...
  for (DeviceList::iterator i = rv.begin(); i != rv.end(); ++i) {
    try {
      // printf("Reading table values for %u\n", *i);
      read_table_values(*i);
    } catch (Exception &e) {
 ...
 */
bool
RobotisAX12A::ping(unsigned char id, unsigned int timeout_ms)
{
  assert_valid_id(id);
  try {
 ...
 */
void
RobotisAX12A::read_table_values(unsigned char id)
{
  // printf("Starting\n");
 ...
 */
void
RobotisAX12A::start_read_table_values(unsigned char id)
{
  assert_valid_id(id);
  unsigned char param[2];
  param[0] = 0x00;
  param[1] = AX12A_CONTROL_TABLE_LENGTH;
 ...
 */
void
RobotisAX12A::finish_read_table_values()
{
  // printf("Receiving\n");
  recv(AX12A_CONTROL_TABLE_LENGTH);

  if (__ibuffer_length != 5 + AX12A_CONTROL_TABLE_LENGTH + 1) {
    throw Exception("Input buffer of invalid size: %u vs. %u", __ibuffer_length, 5 + AX12A_CONTROL_TABLE_LENGTH + 1);
  }
  memcpy(__control_table[__ibuffer[PACKET_OFFSET_ID]],
	 &__ibuffer[PACKET_OFFSET_PARAM], AX12A_CONTROL_TABLE_LENGTH);
}
 ...
 */
void
RobotisAX12A::read_table_value(unsigned char id,
			      unsigned char addr, unsigned char read_length)
{
  ...
  printf("read from %d, addr: %d, read_length: %d\n", id, addr, read_length);
  send(id, INST_READ, param, 2);
  recv(read_length);
 ...
 */
void
RobotisAX12A::write_table_value(unsigned char id, unsigned char addr,
 ...
 */
void
RobotisAX12A::write_table_values(unsigned char id, unsigned char start_addr,
 ...
 */
void
RobotisAX12A::assert_valid_id(unsigned char id)
{
  if (id == BROADCAST_ID) {
    throw Exception("Data can only be queried for a specific servo");
  } else if (id >= AX12A_MAX_NUM_SERVOS) {
    throw OutOfBoundsException("Servo ID out of bounds", id, 0, AX12A_MAX_NUM_SERVOS);
  }
}
 ...
 */
unsigned int
RobotisAX12A::merge_twobyte_value(unsigned int id,
 ...
 */
unsigned int
RobotisAX12A::get_value(unsigned int id, bool refresh,
		       unsigned int ind_l, unsigned int ind_h)
{
  assert_valid_id(id);

#ifdef DEBUG_AX12A_COMM
  printf("read_table_value(%d, %d, %d)\n", id, ind_l, (ind_h == 0xFFFFFFFF ? 1 : 2));
#endif
 ...
 */
unsigned int
RobotisAX12A::get_model(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_position(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_firmware_version(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_baudrate(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_delay_time(unsigned char id, bool refresh)
{
 ...
 */
void
RobotisAX12A::get_angle_limits(unsigned char id,
 ...
 */
unsigned char
RobotisAX12A::get_temperature_limit(unsigned char id, bool refresh)
{
 ...
 */
void
RobotisAX12A::get_voltage_limits(unsigned char id,
 ...
 */
unsigned int
RobotisAX12A::get_max_torque(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_status_return_level(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_alarm_led(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_alarm_shutdown(unsigned char id, bool refresh)
{
 ...
 */
void
RobotisAX12A::get_calibration(unsigned char id,
 ...
 */
bool
RobotisAX12A::is_torque_enabled(unsigned char id, bool refresh)
{
 ...
 */
bool
RobotisAX12A::is_led_enabled(unsigned char id, bool refresh)
{
 ...
 */
void
RobotisAX12A::get_compliance_values(unsigned char id,
 ...
 */
unsigned int
RobotisAX12A::get_goal_position(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_goal_speed(unsigned char id, bool refresh)
{
 ...
 */
float
RobotisAX12A::get_max_supported_speed(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_torque_limit(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_speed(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_load(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_voltage(unsigned char id, bool refresh)
{
 ...
 */
unsigned char
RobotisAX12A::get_temperature(unsigned char id, bool refresh)
{
 ...
 */
bool
RobotisAX12A::is_moving(unsigned char id, bool refresh)
{
 ...
 */
bool
RobotisAX12A::is_locked(unsigned char id, bool refresh)
{
 ...
 */
unsigned int
RobotisAX12A::get_punch(unsigned char id, bool refresh)
{
 ...
 */
void
RobotisAX12A::set_id(unsigned char id, unsigned char new_id)
{
 ...
 */
void
RobotisAX12A::set_baudrate(unsigned char id, unsigned char baudrate)
{
 ...
 */
void
RobotisAX12A::set_return_delay_time(unsigned char id, unsigned char return_delay_time)
{
 ...
 */
void
RobotisAX12A::set_angle_limits(unsigned char id,
			      unsigned int cw_limit, unsigned int ccw_limit)
{
 ...
 */
void
RobotisAX12A::set_temperature_limit(unsigned char id, unsigned char temp_limit)
{
 ...
 */
void
RobotisAX12A::set_voltage_limits(unsigned char id, unsigned char low, unsigned char high)
{
  unsigned char param[2];
  param[0] = low;
  param[1] = high;
 ...
 */
void
RobotisAX12A::set_max_torque(unsigned char id, unsigned int max_torque)
{
 ...
 */
void
RobotisAX12A::set_status_return_level(unsigned char id, unsigned char status_return_level)
{
 ...
 */
void
RobotisAX12A::set_alarm_led(unsigned char id, unsigned char alarm_led)
{
 ...
 */
void
RobotisAX12A::set_alarm_shutdown(unsigned char id, unsigned char alarm_shutdown)
{
 ...
 */
void
RobotisAX12A::set_torque_enabled(unsigned char id, bool enabled )
{
 ...
 */
void
RobotisAX12A::set_torques_enabled(bool enabled, unsigned char num_servos, ...)
{
  if (num_servos > 120) {
 ...
 */
void
RobotisAX12A::set_led_enabled(unsigned char id, bool led_enabled )
{
 ...
 */
void
RobotisAX12A::set_compliance_values(unsigned char id,
				   unsigned char cw_margin, unsigned char cw_slope,
				   unsigned char ccw_margin, unsigned char ccw_slope)
{
 ...
 */
void
RobotisAX12A::set_goal_speed(unsigned char id, unsigned int goal_speed)
{
 ...
 */
void
RobotisAX12A::set_goal_speeds(unsigned int num_servos, ...)
{
  if (num_servos > 83) {
    // not enough space for everything in the parameters..
 ...
 */
void
RobotisAX12A::set_torque_limit(unsigned char id, unsigned int torque_limit)
{
 ...
 */
void
RobotisAX12A::set_punch(unsigned char id, unsigned int punch)
{
 ...
 */
void
RobotisAX12A::lock_config(unsigned char id)
{
 ...
 */
void
RobotisAX12A::goto_position(unsigned char id, unsigned int value)
{
 ...
 */
void
RobotisAX12A::goto_positions(unsigned int num_servos, ...)
{
  if (num_servos > 83) {
    // not enough space for everything in the parameters..
