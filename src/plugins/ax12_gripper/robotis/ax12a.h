...
/***************************************************************************
 *  ax12a.h - Class for accessing Robotis AX12A servos
 *
 *  Created: Sat Feb 28 10:28:25 2015 (based on visca.h)
...
#ifndef __PLUGINS_PANTILT_ROBOTIS_AX12A_H_
#define __PLUGINS_PANTILT_ROBOTIS_AX12A_H_
...
#define AX12A_CONTROL_TABLE_LENGTH 0x32
#define AX12A_MAX_NUM_SERVOS       254
/* #define DEBUG_AX12A_COMM */
...
class RobotisAX12A
{
 public:
  ...
  RobotisAX12A(const char *device_file, unsigned int default_timeout_ms = 30);
  ~RobotisAX12A();
 ...
 private:
  ...
  char          __control_table[AX12A_MAX_NUM_SERVOS][AX12A_CONTROL_TABLE_LENGTH];
