/***************************************************************************
 *  act_thread.cpp - AX12 Gripper plugin act thread (abstract)
 *
 *  Created: Sat Feb 28 10:17:14 2015
...
/** @class GripperActThread "act_thread.h"
 * AX12 Gripper act thread.
 * This thread integrates into the Fawkes main loop at the ACT_EXEC hook and
 * interacts with the controller of a chain of AX12 Servos. Note that this
 * abstract class is then implemented by threads interacting with a particular
 * gripper unit.
 *
 * Each implementation of this thread shall open an instance of a GripperInterface
 ...
 * the GripperSensorThread.
 *
 * @author Tim Niemueller, Nicolas Limpert
 *
 * @fn void GripperActThread::update_sensor_values()
 ...
 */
AX12GripperActThread::AX12GripperActThread(const char *thread_name)
...
/** Destructor. */
AX12GripperActThread::~AX12GripperActThread()
{
}
