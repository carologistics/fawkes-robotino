...
BridgeProcessor::BridgeProcessor(fawkes::LockPtr<fawkes::CLIPSEnvManager> &clips_env_mgr, fawkes::Logger *logger,  fawkes::Configuration *config, fawkes::BlackBoard *blackboard)
{
  ...
  // own_name_ = config_->get_string("/clips-agent/llsf2015/robot-name");
...
// All this commented coz i could not find  config_->get_string("/clips-agent/llsf2015/robot-name"); in the cpnfig file//
