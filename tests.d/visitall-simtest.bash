...
WORKING_DIR=$FAWKES_DIR/tests.out.d/visitall-simtest
mkdir -p $WORKING_DIR
cd $WORKING_DIR
TERMINAL=tmux
export TERMINAL
...
ulimit -c 0
$SCRIPT_PATH/gazsim.bash -o -r --mongodb -m m-skill-sim --central-agent m-central-clips-exec  --team-cyan Carologistics --start-game=PRODUCTION $@
