...
echo "/clips-executive/specs/rcll-labcegor21/parameters/simtest/enabled: true" > $tmpconfig
echo "/clips-executive/spec: rcll-labcegor21" >> $tmpconfig
export FAWKES_DIR
SCRIPT_PATH=$FAWKES_DIR/bin
WORKING_DIR=$FAWKES_DIR/tests.out.d/cx-labcegor21-simtest
mkdir -p $WORKING_DIR
cd $WORKING_DIR
TERMINAL=tmux
export TERMINAL
