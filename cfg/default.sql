...
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/OmniPuck3','string','Position3DInterface::OmniPuck3',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/OmniPuck4','string','Position3DInterface::OmniPuck4',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/OmniPuck5','string','Position3DInterface::OmniPuck5',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/OmniPuck6','string','Position3DInterface::OmniPuck6',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/OmniPuck7','string','Position3DInterface::OmniPuck7',NULL);
...
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/ppnavi','string','NavigatorInterface::Pathplan',NULL);
...
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/ampelswitch','string','SwitchInterface::ampelswitch',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/ampel_green','string','SwitchInterface::ampel_green',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/ampel_red','string','SwitchInterface::ampel_red',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/reading/ampel_orange','string','SwitchInterface::ampel_orange',NULL);
INSERT INTO "config" VALUES('/skiller/interfaces/robotino/writing/light','string','RobotinoAmpelInterface::light',NULL);
...
INSERT INTO "config" VALUES('/plugins/amcl/map_file','string','~map-llsf.png','Image file containing the map, must be a PNG file and a path relative to the config dir');
...
INSERT INTO "config" VALUES('/plugins/amcl/occupied_threshold','float',0.8,'Pixels with occupancy probability greater than this threshold are considered completely occupied. Occupancy probability is the luminance value divided by 255.');
...
INSERT INTO "config" VALUES('/plugins/amcl/laser_min_range','float',0.04,'Laser Minimum Range');
...
INSERT INTO "config" VALUES('/plugins/amcl/max_particles','unsigned int',1000,'Maximum Particles');
...
INSERT INTO "config" VALUES('/plugins/amcl/alpha1','float',1,'Expected noise in odometry''s rotation estimate from the rotational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha2','float',1,'Expected noise in odometry''s rotation estimate from the translational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha3','float',0.6,'Expected noise in odometry''s translational estimate from the translational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha4','float',0.6,'Expected noise in odometry''s translational estimate from the rotational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha5','float',0.6,'Translation related noise parameter (only used for omni motion model)');
INSERT INTO "config" VALUES('/plugins/amcl/z_hit','float',0.95,'Influence of measurement noise, all Z must sum up to 1 (note that z_short and z_max are only used for the beam model)');
INSERT INTO "config" VALUES('/plugins/amcl/z_short','float',0.05,'Influence of short readings, only used for beam model');
INSERT INTO "config" VALUES('/plugins/amcl/z_max','float',0.05,'Influence of missed obstacles, only used for beam model');
INSERT INTO "config" VALUES('/plugins/amcl/z_rand','float',0.05,'Influence of random measurements');
...
INSERT INTO "config" VALUES('/plugins/amcl/laser_likelihood_max_dist','float',1.0,'Laser- Likelihood Maximum Distance');
...
INSERT INTO "config" VALUES('/plugins/amcl/d_thresh','float',0.1,'Update minimum D Thresh');
INSERT INTO "config" VALUES('/plugins/amcl/a_thresh','float',0.05,'Update minimum A Thresh - should be PI/6');
INSERT INTO "config" VALUES('/plugins/amcl/t_thresh','float',10.0,'Time to update after stopping to move; sec');
INSERT INTO "config" VALUES('/plugins/amcl/odom_frame_id','string','/odom','Odometry Frame ID');
...
INSERT INTO "config" VALUES('/plugins/amcl/transform_tolerance','float',3.0,'Transform Tolerance; sec');
INSERT INTO "config" VALUES('/plugins/amcl/alpha_slow','float',0.001,'Alpha Slow Recovery');
INSERT INTO "config" VALUES('/plugins/amcl/alpha_fast','float',0.01,'Alpha Fast Recovery');
...
INSERT INTO "config" VALUES('/plugins/amcl/init_cov_xx','float',0.25,'Initial Covariance xx');
...
INSERT INTO "config" VALUES('/hardware/robotino/omnivision/camera_height','float','0.41','Height of the Mirror in m');
INSERT INTO "config" VALUES('/hardware/robotino/omnivision/colormap_file','string','/bulb-colormap/map4.colormap','Location of the colormap in relation to cfg directory');
...
INSERT INTO "config" VALUES('/plugins/laserclusterdetector/cluster_max_size','unsigned int',15,'minimum number of laser points a cluster must consist of');
...
INSERT INTO "config" VALUES('/plugins/laserclusterdetector/dist_threshold','float',0.2,'allowed difference in distance compared to first laser point in cluster');
INSERT INTO "config" VALUES('/plugins/laserclusterdetector/valid_cluster_radius','float',0.15,'cluster is regarded as valid iff no point is more than radius away from center');
...
INSERT INTO "config" VALUES('/plugins/navgraph/graph_file','string','navgraph-llsf.yaml','Graph File to use for Path planning');
INSERT INTO "config" VALUES('/plugins/navgraph/monitor_file','bool','1','Monitor Graph File and Automatically reload on changes?');
INSERT INTO "config" VALUES('/plugins/navgraph/navigator_interface_id','string','Navigator','Blackboard Interface ID');
INSERT INTO "config" VALUES('/plugins/navgraph/resend_interval','float','4.0','Interval to resend the goto command; sec');
INSERT INTO "config" VALUES('/plugins/navgraph/target_time','float','8.0','Time to keep moving after the target tolerance has been reached; sec');
INSERT INTO "config" VALUES('/plugins/navgraph/travel_tolerance','float','0.25','Allowed movement deviation for waypoint nodes; m');
INSERT INTO "config" VALUES('/plugins/navgraph/target_tolerance','float','0.1','Allowed movement deviation for target nodes; m');
INSERT INTO "config" VALUES('/plugins/navgraph/visualization','bool','1','Visualize Graph and current actions?');
INSERT INTO "config" VALUES('/fawkes/bbsync/check_interval','unsigned int',5000,'Interval in which to check for aliveness, if omitted defaults to 5 seconds; ms');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/host','string','carologistics-25.local','Host name of remote peer; hostname');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/port','unsigned int',1910,'Port of remote peer; TCP port');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/active','bool','1','Is peer active? If omitted 1 is assumed.');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/check_interval','unsigned int',1000,'Interval in which to check for aliveness, if omitted defaults to 5 seconds; ms');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/reading/transform_pose','string','TransformInterface::TF Pose=TF Pose','read the pose');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/reading/pose','string','Position3DInterface::Pose=Pose','read the pose');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/writing/laser','string','Laser360Interface::Laser urg filtered=Laser urg filtered','send the laser data');
INSERT INTO "config" VALUES('/fawkes/bbsync/peers/carologistics-25/writing/transform_ros','string','TransformInterface::TF ROS=TF ROS Sync','send the transform');
