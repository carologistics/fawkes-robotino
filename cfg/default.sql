...
INSERT INTO "config" VALUES('/fawkes/meta_plugins/robotino_default','string','robotino,static-transforms,fvbase,fvretriever,fvfountain,laser,laser-filter,laserclusterdetector,robotino-omnivisionmult-thread,robotino-ros-joints,ros,ros_cmdvel,ros_odometry,ros-tf,skiller,amcl','Example default meta plugin for the Robotino');
...
INSERT INTO "config" VALUES('/plugins/amcl/laser_min_range','float',-1.0,'Laser Minimum Range');
INSERT INTO "config" VALUES('/plugins/amcl/laser_max_range','float',-1.0,'Laser Maximum Range');
...
INSERT INTO "config" VALUES('/plugins/amcl/alpha4','float',0.2,'Expected noise in odometry''s translational estimate from the rotational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha5','float',0.2,'Translation related noise parameter (only used for omni motion model)');
...
INSERT INTO "config" VALUES('/plugins/amcl/alpha_fast','float',0.1,'Alpha Fast Recovery');
