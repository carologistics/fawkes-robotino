...
INSERT INTO "config" VALUES('/plugins/amcl/alpha1','float',0.5,'Expected noise in odometry''s rotation estimate from the rotational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha2','float',0.5,'Expected noise in odometry''s rotation estimate from the translational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha3','float',0.5,'Expected noise in odometry''s translational estimate from the translational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha4','float',0.5,'Expected noise in odome
try''s translational estimate from the rotational component of the robot''s motion');
INSERT INTO "config" VALUES('/plugins/amcl/alpha5','float',0.5,'Translation related noise parameter (only used for omni motion model)');
INSERT INTO "config" VALUES('/plugins/amcl/z_hit','float',0.97,'Influence of measurement noise, all Z must sum up to 1 (note that z_short and z_max are only used for the beam model)');
...
INSERT INTO "config" VALUES('/plugins/amcl/z_rand','float',0.03,'Influence of random measurements');
...
INSERT INTO "config" VALUES('/plugins/amcl/a_thresh','float',0.2,'Update minimum A Thresh - should be PI/6');
...
INSERT INTO "config" VALUES('/plugins/amcl/transform_tolerance','float',0.4,'Transform Tolerance; sec');
